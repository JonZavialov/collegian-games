    ...
    components: {
      ...
      schemas: {
        ...
        UserInfo: {
          ...
          required: ["patronLevel", "remainingCalls"],
          type: "object",
          additionalProperties: false,
        },
        Game: {
    ...
    paths: {
      ...
      "/teams/ats": {
        get: {
          ...
          description: "Retrieves against-the-spread (ATS) summary by team",
          tags: ["teams"],
          security: [
            {
              apiKey: [],
      ...
      "/roster": {
        get: {
          ...
          parameters: [
            ...
            {
              description: "Optional year filter, defaults to 2025",
              in: "query",
              name: "year",
              required: false,
              schema: {
      ...
      "/stats/game/havoc": {
        get: {
          ...
          description: "Retrieves havoc statistics aggregated by game",
          tags: ["stats"],
          security: [
            {
              apiKey: [],
